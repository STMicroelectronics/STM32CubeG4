...
In this application, two operating modes are available:
 ...
 2. Run-time application mode:
    This is the normal run-time activities. A binary which toggles LED1 on the STM32G474E-EVAL Rev B board is
    provided in Binary directory.

@note After each device reset (unplug the STM32G474E-EVAL Rev B board from PC), Plug the STM32G474E-EVAL Rev B board with Key User push-button button
...
@note A binary which toggles LED1 on the STM32G474E-EVAL Rev B board is provided in Binary directory.
