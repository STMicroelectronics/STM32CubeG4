...
STM32G474E-EVAL Rev B's LED can be used to monitor the application status:
...
@par Directory contents
  ...
  - FatFs/FatFs_uSD_Standalone/FATFS/Target/stm32g474e_eval_conf.h        BSP configuration file
