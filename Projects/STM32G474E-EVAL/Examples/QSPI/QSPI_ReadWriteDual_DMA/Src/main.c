...
/**
  ******************************************************************************
  * @file    QSPI/QSPI_ReadWriteDual_DMA/Src/main.c
...
uint8_t aTxBuffer[] = " ****Dual flash QSPI communication based on DMA****  ****Dual flash QSPI communication based on DMA****  ****Dual flash QSPI communication based on DMA****  ****Dual flash QSPI communication based on DMA**** ";
