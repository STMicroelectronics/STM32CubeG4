...
/**
  ...
  *         -3- Configure the DMA1_Channel1 functional parameters for Tx
  *         -4- Configure the DMA1_Channel2 functional parameters for Rx
  *         -5- Enable DMA1_Channel1 and DMA1_Channel2 DMA transfer complete/error interrupts
  * @param  None
  * @retval None
  */
void Configure_SPI1_DMA(void)
...
void Configure_USART1(void)
{
  ...
  /* Configure transfer bit order : LSB first */
