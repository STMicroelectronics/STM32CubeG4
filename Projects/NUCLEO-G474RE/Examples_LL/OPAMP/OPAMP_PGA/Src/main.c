...
void UserButton_Callback(void)
{
  ...
  else
  {
    ...
    {
      case 1:
        OpampPgaGain = LL_OPAMP_PGA_GAIN_4_OR_MINUS_3;
        break;
      case 2:
        OpampPgaGain = LL_OPAMP_PGA_GAIN_8_OR_MINUS_7;
        break;
      case 3:
        OpampPgaGain = LL_OPAMP_PGA_GAIN_16_OR_MINUS_15;
        break;
      default:
        OpampPgaGain = LL_OPAMP_PGA_GAIN_2_OR_MINUS_1;
    }
