...
/**
  ******************************************************************************
  * @file    Examples_LL/HRTIM/HRTIM_Basic_PWM_Master/Src/main.c
...
static void MX_HRTIM1_Init(void)
{
  ...
  LL_HRTIM_TIM_SetPeriod(HRTIM1, LL_HRTIM_TIMER_MASTER, MASTER_PERIOD);
  ...
  LL_HRTIM_TIM_SetCompare1(HRTIM1, LL_HRTIM_TIMER_MASTER, (uint32_t)(MASTER_PERIOD * MASTER_DUTY_CYCLE));
  ...
  LL_HRTIM_OUT_SetOutputSetSrc(HRTIM1, LL_HRTIM_OUTPUT_TD2, LL_HRTIM_OUTPUTSET_MASTERPER);
  LL_HRTIM_OUT_SetOutputResetSrc(HRTIM1, LL_HRTIM_OUTPUT_TD2, LL_HRTIM_OUTPUTRESET_MASTERCMP1);
