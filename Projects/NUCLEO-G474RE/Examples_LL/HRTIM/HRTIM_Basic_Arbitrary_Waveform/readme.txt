/**
  @page HRTIM_Basic_Arbitrary_Waveform HRTIM example
  
  @verbatim
  ******************************************************************************
  * @file    Examples_LL/HRTIM/HRTIM_Basic_Arbitrary_Waveform/readme.txt 
  * @author  MCD Application Team
  * @brief   Description of the HRTIM_Basic_Arbitrary_Waveform example.
  ******************************************************************************
  * @attention
  *
...
@par Directory contents 
  ...
  - HRTIM/HRTIM_Basic_Arbitrary_Waveform/Inc/main.h                  Header for main.c module  
  - HRTIM/HRTIM_Basic_Arbitrary_Waveform/Src/stm32g4xx_it.c          IT interrupt handlers
  - HRTIM/HRTIM_Basic_Arbitrary_Waveform/Src/main.c                  Main program
  - HRTIM/HRTIM_Basic_Arbitrary_Waveform/Src/system_stm32g4xx.c      STM32G4xx system source file
