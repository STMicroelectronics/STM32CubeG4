...
/**
  ******************************************************************************
  * @file    Examples_LL/HRTIM/HRTIM_Basic_Arbitrary_Waveform/Src/main.c
...
static void MX_HRTIM1_Init(void)
{
  ...
  LL_HRTIM_OUT_SetOutputSetSrc(HRTIM1, LL_HRTIM_OUTPUT_TD1, LL_HRTIM_OUTPUTSET_TIMPER|LL_HRTIM_OUTPUTSET_TIMCMP1
                              |LL_HRTIM_OUTPUTSET_TIMCMP2);
  LL_HRTIM_OUT_SetOutputResetSrc(HRTIM1, LL_HRTIM_OUTPUT_TD1, LL_HRTIM_OUTPUTRESET_TIMPER|LL_HRTIM_OUTPUTRESET_TIMCMP1
  ...
  LL_HRTIM_OUT_SetOutputSetSrc(HRTIM1, LL_HRTIM_OUTPUT_TD2, LL_HRTIM_OUTPUTSET_TIMPER|LL_HRTIM_OUTPUTSET_TIMCMP2);
  LL_HRTIM_OUT_SetOutputResetSrc(HRTIM1, LL_HRTIM_OUTPUT_TD2, LL_HRTIM_OUTPUTRESET_TIMCMP1|LL_HRTIM_OUTPUTRESET_TIMCMP3);
