...
void HAL_TIM_OC_DelayElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  /* TIM1_CH1 toggling with frequency = 2125 Hz */
  ...
  /* TIM1_CH2 toggling with frequency = 4250 Hz */
  ...
  /* TIM1_CH3 toggling with frequency = 8500 Hz */
  ...
  /* TIM1_CH4 toggling with frequency = 17000 Hz */
