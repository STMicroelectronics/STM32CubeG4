...
The WWDG timeout is set, through counter value, to 447,4 ms.
The refresh window is set in order to make user wait 167,7 ms after a wadchdog refresh,
before writing again counter. Hence the WWDG counter is refreshed each (167,7 + 1) ms in the
...
@par Directory contents
  ...
  - WWDG/WWDG_Example/Inc/stm32g4xx_nucleo_conf.h     BSP configuration file
  ...
  - WWDG/WWDG_Example/Src/stm32g4xx_it.c          Interrupt handlers
  - WWDG/WWDG_Example/Src/main.c                        Main program
  - WWDG/WWDG_Example/Src/stm32g4xx_hal_msp.c     HAL MSP file
  - WWDG/WWDG_Example/Src/system_stm32g4xx.c      STM32G4xx system source file
