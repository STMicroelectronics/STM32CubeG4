...
/**
  ******************************************************************************
  * @file    Examples/HRTIM/HRTIM_Basic_MultiplePWM/Src/main.c
...
int main(void)
{
  ...
  /* Enable HRTIM's outputs TA1, TA2, TD1 and TD2 and start timers A and D */
...
static void MX_HRTIM1_Init(void)
{
  ...
  pCompareCfg.CompareValue = TIMA_PERIOD/4;
  if (HAL_HRTIM_WaveformCompareConfig(&hhrtim1, HRTIM_TIMERINDEX_TIMER_A, HRTIM_COMPAREUNIT_1, &pCompareCfg) != HAL_OK)
  {
    Error_Handler();
  }
  pCompareCfg.CompareValue = TIMA_PERIOD/2;
  ...
  pCompareCfg.CompareValue = (3*TIMA_PERIOD)/4;
