...
In order to start the timer a first trigger is needed on (PB6)(LPTIM_ETR).
Any successive trigger event on (PB6) will reset the counter and the timer 
...
@par Directory contents
  ...
  - LPTIM/LPTIM_Timeout/Src/stm32g4xx_it.c          Interrupt handlers
  - LPTIM/LPTIM_Timeout/Src/main.c                  Main program
  - LPTIM/LPTIM_Timeout/Src/stm32g4xx_hal_msp.c     HAL MSP module
  - LPTIM/LPTIM_Timeout/Src/system_stm32g4xx.c      STM32G4xx system source file
...
@par Hardware and Software environment
  ...
  - Connect an external trigger (ETR) to PB6(pin 17 in CN10 connector). 
