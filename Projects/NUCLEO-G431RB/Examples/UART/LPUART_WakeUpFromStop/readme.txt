...
@par Hardware and Software environment
  ...
  - This example has been tested with a couple of NUCLEO-G431RB RevC boards embedding a
    STM32G431RBT6 device and can be easily tailored to any other supported device
