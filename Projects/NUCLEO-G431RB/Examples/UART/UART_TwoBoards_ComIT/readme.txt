...
Board: NUCLEO-G431RB (embeds a STM32G431RBTx device)
...
NUCLEO-G431RB board LED is used to monitor the transfer status:
...
@par Directory contents 
  ...
  - UART/UART_TwoBoards_ComIT/Src/stm32g4xx_it.c          IT interrupt handlers
  - UART/UART_TwoBoards_ComIT/Src/main.c                  Main program
  - UART/UART_TwoBoards_ComIT/Src/stm32g4xx_hal_msp.c     HAL MSP module
  - UART/UART_TwoBoards_ComIT/Src/system_stm32g4xx.c      STM32G4xx system source file


@par Hardware and Software environment 

  - This example runs on STM32G431RBTx devices.    
  - This example has been tested with two NUCLEO-G431RB boards embedding
