...
This example demonstrates how to use the NUCLEO-G431RB board to blink an LED at different speeds when the user button is pressed.
The LED blinks at three different speeds, and each press of the user button changes the blinking speed.

On NUCLEO-G431RB RevC:
...
@note The GPIO_Demo example provides the source code for the demonstration binary package, which can be downloaded
      from the NUCLEO-G431RB webpage. For more details, please see the Binary Resources section here:
      https://www.st.com/en/evaluation-tools/nucleo-g431rb.html#tools-software
...
@par Directory contents 
  ...
  - GPIO/GPIO_Demo/Inc/stm32g4xx_nucleo_conf.h     BSP configuration file
  - GPIO/GPIO_Demo/Inc/stm32g4xx_hal_conf.h    HAL configuration file
  - GPIO/GPIO_Demo/Inc/stm32g4xx_it.h          Interrupt handlers header file
  - GPIO/GPIO_Demo/Inc/main.h                  Header for main.c module  
  - GPIO/GPIO_Demo/Src/stm32g4xx_it.c          Interrupt handlers
  - GPIO/GPIO_Demo/Src/stm32g4xx_hal_msp.c     HAL MSP file
  - GPIO/GPIO_Demo/Src/main.c                  Main program
  - GPIO/GPIO_Demo/Src/system_stm32g4xx.c      STM32G4xx system source file
