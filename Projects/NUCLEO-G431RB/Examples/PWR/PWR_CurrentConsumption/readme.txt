/**
  @page PWR_CurrentConsumption PWR example
...
To run this example, user has to follow these steps:
 1. Select the Low power modes to be measured by uncommenting the corresponding
    line inside the "stm32g4xx_lp_modes.h file.
    @code
       /* #define SLEEP_MODE               */
       /* #define STOP_MODE                */
...
--> In anyway, wrong end of test is showing (LED2) toggling 
...
@par Directory contents 
  ...
  - PWR/PWR_CurrentConsumption/Inc/stm32g4xx_lp_modes.h     Low Power Modes header file
  - PWR/PWR_CurrentConsumption/Src/stm32g4xx_it.c           Interrupt handlers
  - PWR/PWR_CurrentConsumption/Src/main.c                         Main program
  - PWR/PWR_CurrentConsumption/Src/stm32g4xx_hal_msp.c      HAL MSP module
  - PWR/PWR_CurrentConsumption/Src/stm32g4xx_lp_modes.c     STM32G4xx Low Power Modes source file
  - PWR/PWR_CurrentConsumption/Src/system_stm32g4xx.c       STM32G4xx system clock configuration file
...
@par Hardware and Software environment
  ...
  - NUCLEO-G431RB RevC Set-up
    - Use LED2 connected to PA05 pin.
      * LED2 (GREEN) will slowly toggle (1sec.) waiting for user to launch test, then will turn OFF
      * LED2 (GREEN) will toggle fast (100ms) while returning from STANDBY mode (PWR flag check callback) 
      * LED2 (GREEN) will toggle fast (100ms) at the end of test in case of success.
