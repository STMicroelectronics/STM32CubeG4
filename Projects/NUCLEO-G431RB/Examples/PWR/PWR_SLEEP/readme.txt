...
In the associated software, the system clock is set to 150 MHz.
...
@note To measure the current consumption in SLEEP mode, remove JP4 jumper 
...
@par Directory contents 
  ...
  - PWR/PWR_SLEEP/Src/system_stm32g4xx.c       STM32G4xx system clock configuration file
  - PWR/PWR_SLEEP/Src/stm32g4xx_it.c           Interrupt handlers
  - PWR/PWR_SLEEP/Src/stm32g4xx_hal_msp.c      HAL MSP module
