...
The NUCLEO-G431RB RevC board LEDs can be used to monitor the transfer status:
...
@par Directory contents
  ...
  - FLASH/FLASH_EraseProgram/Inc/stm32g4xx_nucleo_conf.h     BSP configuration file
