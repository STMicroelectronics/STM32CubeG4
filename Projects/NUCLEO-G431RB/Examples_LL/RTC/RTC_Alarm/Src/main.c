/**
  ...
  * @brief   This example code shows how to use STM32G4xx RTC LL API to configure
  *          an alarm.
...
void SystemClock_Config(void)
{
  ...
  /* Set systick to 1ms in using frequency set to 150MHz */
  /* This frequency can be calculated through LL RCC macro */
  /* ex: __LL_RCC_CALC_PLLCLK_FREQ(__LL_RCC_CALC_HSI_FREQ(),
                                  LL_RCC_PLLM_DIV_4, 75, LL_RCC_PLLR_DIV_2)*/
