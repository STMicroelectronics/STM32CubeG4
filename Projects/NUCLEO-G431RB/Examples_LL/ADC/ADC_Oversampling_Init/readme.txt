...
Example execution:
At each press on User push-button, with the 3 oversampling setting:
...
@par Directory contents 
  ...
  - ADC/ADC_Oversampling_Init/Inc/stm32g4xx_it.h          Interrupt handlers header file
  ...
  - ADC/ADC_Oversampling_Init/Src/stm32g4xx_it.c          Interrupt handlers
  - ADC/ADC_Oversampling_Init/Src/main.c                  Main program
  - ADC/ADC_Oversampling_Init/Src/system_stm32g4xx.c      STM32G4xx system source file
