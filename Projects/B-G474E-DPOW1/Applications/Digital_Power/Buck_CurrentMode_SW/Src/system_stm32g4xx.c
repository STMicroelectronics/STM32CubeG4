 ...
 * @history ---------- ------- ------- ----------------------------------------
  ...
  * @history 2021-12-23 1.0     RGo     Adding CCM RAM support
  * @history 2022-01-05 1.0     RGo     Header modifications
 */
...
#elif defined( VECT_TAB_CCM_SRAM )
  SCB->VTOR = CCMSRAM_BASE | VECT_TAB_OFFSET; /* Vector Table Relocation in CCM SRAM */
#else
