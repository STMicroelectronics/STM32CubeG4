/**
  ...
  * @brief   PSU - Buck converter (Voltage mode) in CCM using HRTIMER+FMAC IPs
  ******************************************************************************
  *
...
The control loop is performed in voltage mode and compensator is executed through the FMAC IP usage.
...
PSU, BUCK converter, Voltage mode, CCM, STM32 Digital Power, HRTIMER usage, FMAC usage
...
In order to run the program, please do the following:
 ...
 - Generate the application example
