 ...
 * @history ---------- ------- ------- ----------------------------------------
  ...
  * @history 2021-12-22 1.0     NSa     Updating code to manage both an open loop buck and
                                        a closed loop boost
...
//#endif /* DSMPS_DEBUG */
  ...
  __HAL_HRTIM_SETCOMPARE( &hhrtim1, HRTIM_TIMERINDEX_TIMER_D, HRTIM_COMPAREUNIT_1, tmp);
