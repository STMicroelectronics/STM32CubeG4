...
/**
  ...
  */
  ...
  #define HSI48_VALUE   ((uint32_t)48000000U) /*!< Value of the Internal High Speed oscillator for USB FS/RNG in Hz.
...
/**
  ...
  */
  ...
  #define EXTERNAL_I2S_CLOCK_VALUE    ((uint32_t)48000U) /*!< Value of the I2S External clock source in Hz*/
...
#ifdef HAL_USBPD_MODULE_ENABLED
  #include "stm32g4xx_hal_usbpd.h"
#endif /* HAL_USBPD_MODULE_ENABLED */
