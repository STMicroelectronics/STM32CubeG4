...
Upon each press on Joystick Sel push-button, the offset configuration changes to next one in list:
...
Note: when configuration #4 is selected, a press on Joystick Sel push-button returns to initial
...
Other peripherals used:
  1 GPIO for LED
  1 GPIO for analog input: PF0 (pin 26 on connector CN9)
...
Board settings:
 - The voltage input on the ADC external channel can be provided by an external source
   connected to pin 26 on connector CN9.
...
@par Directory contents 
  ...
  - ADC/ADC_OffsetCompensation/Inc/b_g474e_dpow1_conf.h     BSP configuration file
