...
In this example, the comparator input is connected on the pin PA1 (pin 29 on connector CN8) the user shall apply a voltage on it.
The DAC output is connected internally to comparator other input, and externally to the pin PA4 (pin 26 on connector CN8).
The comparator output is connected to the pin PA0 (pin 30 on connector CN8).
...
1 - Comparator INP: PA1 (pin 29 on connector CN8)
2 - Comparator INM: PA4 (pin 26 on connector CN8)
3 - Comparator OUT: PA0 (pin 30 on connector CN8)
...
@par Directory contents 
  ...
  - COMP/COMP_CompareGpioVsDacInt_OutputGpio/Inc/b_g474e_dpow1_conf.h     BSP configuration file
...
@par Hardware and Software environment 
  ...
  - Apply an external variable voltage on PA1 (connected on pin 29 on CN8) make it vary from 0 to 3.3V.
