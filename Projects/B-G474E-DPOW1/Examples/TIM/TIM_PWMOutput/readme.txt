...
LED5 is ON when there are an error.
...
@par Hardware and Software environment
  ...
  - B-G474E-DPOW1 Set-up
   Connect the following pins to an oscilloscope to monitor the different waveforms:
        - TIM1_CH1 : PC.00 (pin 28 in CN9 connector)
        - TIM1_CH2 : PA.09 (pin 5 in CN9 connector)
        - TIM1_CH3 : PA.10 (pin 6 in CN9 connector)
        - TIM1_CH4 : PC.03 (pin 31 in CN8 connector)
