...
void HRTIM1_TIMC_IRQHandler(void)
{
  ...
  {
    CurrentDuty++;
    LL_HRTIM_TIM_SetCompare1(HRTIM1, LL_HRTIM_TIMER_C, CurrentDuty);// Duty cycle update
    LL_HRTIM_TIM_SetCompare2(HRTIM1, LL_HRTIM_TIMER_C, CurrentDuty/2); // ADC trigger position update
  }
