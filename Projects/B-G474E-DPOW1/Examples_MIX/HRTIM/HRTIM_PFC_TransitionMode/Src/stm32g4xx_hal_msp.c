...
/**
  ...
  * @version      V1.0.0
  * @date         06-Jan-2022
  * @brief        Hardware abstraction layer for MSP
  * @details      This file provides code for MSP initialization and 
  *               de-initialization
  ******************************************************************************
  *
...
void HAL_HRTIM_MspInit(HRTIM_HandleTypeDef* hhrtim)
{
  ...
  /* USER CODE END HRTIM1_MspInit 0 */
    ...
    PB9     ------> HRTIM1_EEV5
    */
    GPIO_InitStruct.Pin = ZCD_in_Pin|OC_in_Pin;
...
void HAL_HRTIM_MspPostInit(HRTIM_HandleTypeDef* hhrtim)
{
  ...
  /* USER CODE END HRTIM1_MspPostInit 0 */
    ...
    PA8     ------> HRTIM1_CHA1
    */
    GPIO_InitStruct.Pin = BLANKING_WINDOWS_Pin|PFC_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    ...
    GPIO_InitStruct.Pin = BUCK_GREEN_DRIVE_Pin|ZCD_out_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_HRTIM_MspDeInit(HRTIM_HandleTypeDef* hhrtim)
{
  ...
  /* USER CODE END HRTIM1_MspDeInit 0 */
    ...
    PB9     ------> HRTIM1_EEV5
    */
    HAL_GPIO_DeInit(GPIOB, BLANKING_WINDOWS_Pin|PFC_PWM_Pin|ZCD_in_Pin|OC_in_Pin);

    HAL_GPIO_DeInit(GPIOC, OC_out_Pin|BUCK_GREEN_DRIVE_Pin|ZCD_out_Pin);

    HAL_GPIO_DeInit(BUCK_BLUE_DRIVE_GPIO_Port, BUCK_BLUE_DRIVE_Pin);
