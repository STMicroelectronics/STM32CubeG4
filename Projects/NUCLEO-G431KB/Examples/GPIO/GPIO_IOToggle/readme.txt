...
PB.08 IO (configured in output pushpull mode) toggles in a forever loop.
On NUCLEO-G431KB RevA board this IO is connected to LED2.
...
@par Directory contents 
  ...
  - GPIO/GPIO_IOToggle/Inc/stm32g4xx_nucleo_conf.h     BSP configuration file
