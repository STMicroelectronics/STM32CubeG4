...
The SystemClock_Config() function is used to configure the system clock for STM32G431KBTx Devices :
The CPU at 170 MHz 
...
@par Hardware and Software environment
  ...
  - This example has been tested with STMicroelectronics NUCLEO-G431KB 
    board and can be easily tailored to any other supported device 
    and development board.      

  - NUCLEO-G431KB RevA Set-up
   Connect the following pins to an oscilloscope to monitor the different waveforms:
        - TIM1_CH1 : PA.08 (pin 12 in CN4 connector)
        - TIM1_CH2 : PA.09 (pin 1 in CN4 connector)
        - TIM1_CH3 : PA.10 (pin 2 in CN4 connector)
        - TIM1_CH4 : PA.11 (pin 13 in CN4 connector)
