...
The NUCLEO-G491RE RevA board LEDs can be used to monitor the transfer status:
...
@par Directory contents
  ...
  - FLASH/FLASH_FastProgram/Inc/stm32g4xx_nucleo_conf.h     BSP configuration file
