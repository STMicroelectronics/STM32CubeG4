...
NUCLEO-G491RE RevA's LEDs can be used to monitor the application status:
...
@par Hardware and Software environment
  ...
  - This application runs on STM32G491RETx devices.

  - This application has been tested with NUCLEO-G491RE RevA board and can be
